...
export const LIQUIDITY_POOL_PROGRAM_ID_V5 = 'SwaPpA9LAaLfeLi3a68M4DjnLqgtticKg6CnyNwgAC8'
...
export const STAKE_PROGRAM_ID_V6 = 'HTpjeN1FocdopyJxwFJzBsQ5edeDVXkNB3ssePWmhfyj'
